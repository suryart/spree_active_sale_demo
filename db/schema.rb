...
ActiveRecord::Schema.define(:version => 20131210182079) do
  ...
  create_table "spree_active_sale_events", :force => true do |t|
    t.string   "name"
    t.text     "description"
    ...
    t.boolean  "single_product_sale",  :default => false
  end
  ...
  create_table "spree_sale_products", :force => true do |t|
    t.integer  "product_id"
  ...
  create_table "spree_sale_properties", :force => true do |t|
    t.integer  "active_sale_event_id"
    t.integer  "property_id"
    t.integer  "position",             :default => 0
    t.datetime "created_at",                          :null => false
  ...
  create_table "spree_sale_taxons", :force => true do |t|
    t.integer  "taxon_id"
    t.integer  "active_sale_event_id"
    t.integer  "position",             :default => 0
    t.datetime "created_at",                          :null => false
